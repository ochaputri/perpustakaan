           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="?page=transaksi"><i class="fa fa-edit fa-2x"></i></i> Data Transaksi Buku</a>
                    </li>
                    <li>
                        <a  href="?page=transaksipaket"><i class="fa fa-edit fa-2x"></i></i> Data Transaksi Buku Paket</a>
                    </li>
